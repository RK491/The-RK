...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('🔔 BOT Updates 🤖', url='https://telegram.me/imtherk1')
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⚡ Movie Updates ⚡', url=f"https://telegram.me/real_MoviesAdda1"),
            InlineKeyboardButton('🔔 BOT Updates 🤖', url='https://t.me/Imtherk1')
            ],[
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [InlineKeyboardButton('FOLLOW', url='https://www.instagram.com/iammoneyangel?igsh=MWNmODNqaW15bGw4Zw==')] ] ),
        protect_content=True if pre == 'filep' else False,
        )
